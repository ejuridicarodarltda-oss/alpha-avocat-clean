-- Ensure backend infrastructure for "Procesar Excel depurado" exists and is usable by authenticated users.
...
alter table if exists public.cause_excel_upload_batches
...
grant select, insert, update on public.cause_excel_upload_batches to authenticated, service_role;
grant select, insert, update on public.cause_excel_upload_rows to authenticated, service_role;
grant select on public.cause_excel_upload_batch_rows to authenticated, service_role;
