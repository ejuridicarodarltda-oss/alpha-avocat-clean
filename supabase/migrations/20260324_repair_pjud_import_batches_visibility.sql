-- Repair migration for PJUD batch imports.
-- Ensures `public.pjud_import_batches` / `public.pjud_import_rows` exist and are visible to PostgREST roles.
...
-- Normalize/repair columns in case tables existed with partial shape.
